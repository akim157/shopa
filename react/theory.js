...
/*=============== 138.Http Clients (Http Клиенты) ==================*/
//Front-end  <-|HTTP|-> Back-end
//A lightweight library for building Uls (Легкая библиотека для сборки Uls)
//State <-|-> View/DOM
//----------------
//React | Angular
//Use your preferred libs (Используйте ваши любимые библиотеки) | Use HttpModule (использует HttpModule)
//----------------
//Fetch API (Получить API)
//jQuery AJAX
//Axios
//----------------
//npm i axios (устновка библиотеки)
//https://github.com/axios/axios
/*=============== 139.Getting Data (Получение данных) ==================*/
//App.js
import React, { Component } from "react";
...
export default App;
/*=============== 140.Creating Data (Создание данных) ==================*/
//app.js
import React, { Component } from "react";
import axios from 'axios';
import "./App.css";
